...
master = Tk()
label1 = Label(master, text = 'Close Price Today', relief = 'groove', width = 25)
label2 = Label(master, text = 'Close Price Tomorrow', relief = 'groove', width = 25)
...
button1 = Button(master, text = 'Predict Close Price', relief = 'groove', width = 20, command = close_value)
