...
#Parties
label0 = Label(master, text = 'Party A', relief = 'groove', width = 40)
label1 = Label(master, text = 'Party B', relief = 'groove', width = 40)
Party_A = Entry(master, relief = 'groove', width = 40)
Party_B = Entry(master, relief = 'groove', width = 40)

#Consideration
label2 = Label(master, text = 'Party A Consideration', relief = 'groove', width = 40)
label3 = Label(master, text = 'Party B Consideration', relief = 'groove', width = 40)
Party_A_C = Entry(master, relief = 'groove', width = 40)
Party_B_C = Entry(master, relief = 'groove', width = 40)

#Signed
label4 = Label(master, text = 'Party A Sign', relief = 'groove', width = 40)
label5 = Label(master, text = 'Party B Sign', relief = 'groove', width = 40)
...
def write():
    ...
    #Openfile
    with open('B_Train_Public_Ledger.csv', 'a') as csvfile:
    #define fieldnames
